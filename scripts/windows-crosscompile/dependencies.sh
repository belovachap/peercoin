...
#mxe
sudo apt-get -qq update && apt-get -yqq install python-software-properties software-properties-common
...
sudo apt-get -qq update && apt-get -yqq install mxe-i686-w64-mingw32.static-boost mxe-i686-w64-mingw32.static-qttools
